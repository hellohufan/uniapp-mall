<template>
	<view class="product-con">
			   ...
			   <scroll-view :scroll-top="scrollTop" scroll-y='true' scroll-with-animation="true" :style='"height:"+height+"px;"' @scroll="scroll">
				<view id="past0">
					...
					<view class='wrapper'>
						...
						<view class='coupon acea-row row-between-wrapper' @click='couponTap' style="margin-top: 20rpx;" v-if="couponList.length>0">
							<view class='hide line1 acea-row'>
								优惠券：
		...
		<view class='footer acea-row row-between-wrapper'>
			...
			<view open-type='switchTab' class="animated item" :class="animated==true?'bounceIn':''" @click="goCar">
